...
android {
    namespace = "com.ichsnn.myreactivesearch"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.ichsnn.myreactivesearch"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
        ...
        val mapBoxApiKey = gradleLocalProperties(rootDir).getProperty("MAPBOX_API_TOKEN") ?: ""

        buildConfigField("String", "MAPBOX_API_TOKEN", "\"$mapBoxApiKey\"")
    }
